...
<div className='w-[60%] flex flex-col gap-8  lg:gap-12 xl:gap-14'>
  <div className='flex gap-6'>
  <div className='w-[50%] flex items-center '>
        <img src={img1} alt="" className='w-11'/>
        <div className=' ps-4'>
            <h1 className='text-[22px] font-semibold'>30</h1>
            <p className='font-publicSans text-[#6D737A]  font-medium'>Instructor  Language Coach</p>
        </div>
    </div>
    <div className='w-[50%] flex items-center '>
        ...
        <div className=' ps-4'>
            ...
            <p className='font-publicSans text-[#6D737A]  font-medium'>Interactive Courses and Activities</p>
        </div>
    </div>
  </div>
  ...
  <div className='w-[50%] flex items-center '>
        ...
        <div className=' ps-4'>
            ...
            <p className='font-publicSans text-[#6D737A] font-medium'>Students Successfully Trained</p>
        </div>
    </div>
    <div className='w-[50%] flex items-center '>
        ...
        <div className=' ps-4'>
            ...
            <p className='font-publicSans text-[#6D737A] font-medium'>Student Satisfaction Rate</p>
        </div>
    </div>
  </div>
